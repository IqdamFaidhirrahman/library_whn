                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th
                                    ...
                                    <button @click="window.dispatchEvent(new CustomEvent('show-tambah-koleksi'))"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex gap-2 justify-end">
                                        <button @click="window.dispatchEvent(new CustomEvent('show-detail-koleksi'))"
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-black">Skripsi</td>
